...
DROP TABLE IF EXISTS team4_projectdb.prediction_samples;
CREATE EXTERNAL TABLE team4_projectdb.prediction_samples(
    DepDelayMinutes INT,
    DepDelay INT,
    ArrDelayMinutes INT,
    AirTime INT,
...
location '/user/team4/project/hive/warehouse/prediction_samples'; 
