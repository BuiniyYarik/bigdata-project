...
DROP TABLE IF EXISTS team4_projectdb.q2_results;
CREATE EXTERNAL TABLE team4_projectdb.q2_results(
...
location '/user/team4/project/hive/warehouse/q2'; 
