...
DROP TABLE IF EXISTS team4_projectdb.q6_results;
CREATE EXTERNAL TABLE team4_projectdb.q6_results(
month INTEGER, 
TotalNum INTEGER,
...
location '/user/team4/project/hive/warehouse/q6'; 
...
FROM team4_projectdb.flights GROUP by month) AS t
ORDER BY month;
