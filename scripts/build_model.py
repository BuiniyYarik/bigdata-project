...
HDFS_BASE_PATH = "/user/team4/project"
LOCAL_BASE_PATH = os.path.expanduser("~/project/bigdata-project")
MODEL_PATH = HDFS_BASE_PATH + "/models"
DATA_PATH = HDFS_BASE_PATH + "/data"
OUTPUT_PATH = HDFS_BASE_PATH + "/output"
...
# .config("spark.executor.cores", 4).config("spark.executor.memory", "10g") \
...
print(f"Test area under ROC for the third model: {mlp_roc}")
print(f"Test area under PR for the third model: {mlp_pr}")
